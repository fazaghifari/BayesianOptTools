...
def uncGA (fitnessfcn, lb, ub, opt,disp=False,**kwargs):
    ...
    for i in range(0, npop):
        ...
        if num == None:
            ...
            temp= fitnessfcn(population[i,0:nvar],num=num)
    ...
    while generation <= maxg:
        ...
        for jj in range (0,npop,2):
            ...
            if num == None:
                ...
                tempopulation[jj,nvar]= fitnessfcn(tempopulation[jj,lst],num=num)
                tempopulation[jj+1,nvar]= fitnessfcn(tempopulation[jj+1,lst],num=num)
        ...
        for kk in range (1,(2*npop)):
            ...
            if num == None:
                ...
                compopulation[kk,nvar]= fitnessfcn (compopulation[kk,0:nvar],num=num)
...
def GAEEI (fitnessfcn, lb, ub, opt,num):
    ...
    while generation <= maxg:
        ...
        x = population[0,:]
        expimp,_,_ = fitnessfcn(x,num=num)
