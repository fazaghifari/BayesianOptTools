...
def run_akmcs(krigobj,init_samp,problem,filename):
    ...
    akmcsobj.run(savedatato=filename,logging=False)
    elapsed = time.time() - t
...
if __name__ == '__main__':
    ...
    xtotal=run_akmcs(krigobj,init_samp,problem,filename)
    print(Pfreal)
    ...
    np.savetxt('../innout/akmcs2d/MCpop_styb.csv', init_samp, fmt='%10.5f', delimiter=',')
    np.savetxt('../innout/akmcs2d/akmcsXtot_styb.csv', xtotal, fmt='%10.5f', delimiter=',')
