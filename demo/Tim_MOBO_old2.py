...
if __name__ == '__main__':
    df = pd.read_csv('../innout/tim/In/opt_data_AS_old_all10mod.csv', sep=',', index_col='Name')
    data = df.values
    ...
    np.savetxt("../innout/tim/Out/nextpoints_oldAS_all11.csv", totalupdate, delimiter=",",
