...
init_samp = AKMCS.mcpopgen(type="lognormal",stddev=0.2,ndim=nvar,n_order=5,n_coeff=3,mean=1)
init_krigsamp = AKMCS.mcpopgen(type="lognormal",stddev=0.2,ndim=nvar,n_order=1,n_coeff=5,mean=1)
